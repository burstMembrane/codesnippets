...
p5.prototype.VidaBlob = function(_sketch) {
    ...
    */
    this.normMassCenterX = 0.0;
    this.normMassCenterY = 0.0;
    this.normMass = 0.0;
    /*
...
p5.prototype.Vida.prototype.drawBlobs = function(
    ...
    */
    ...
    for (var i = 0; i < this.__blobs[this.__currentBlobsLocation].length; i++) {
        ...
        this.__sketch.stroke(0, 255, 255);
        ...
        for (
            var j = 0; j < this.__blobs[this.__currentBlobsLocation][i].approximatedPolygon.length; j++
        ) {
            this.__sketch.vertex(
                this.__blobs[this.__currentBlobsLocation][i].approximatedPolygon[j].normX *
                _w,
                this.__blobs[this.__currentBlobsLocation][i].approximatedPolygon[j].normY *
                _h,
            );
        }
