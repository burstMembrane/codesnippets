var myVid;
var vidFiles = ["./productreview_downscaled.mp4"];
...
// LOAD SCREEN
var letterBag = ["KNOW", "YOUR", "PRODUCT"];
...
function preload() {
    track = loadSound("./productreview_downscaled.mp3");
        ...
        if (!interactionStartedFlag) {
            ...
            for (var x = 0; x < 4; x++) {
                if (frameCount % 2 == 0) {
                    ...
                    for (var i = 0; i < 100; i++) {
                        ellipse(width / 2, height / 2, frameCount - (i * 50), frameCount - (i * 50));
                    }
                    text(
                        letterBag[x],
                        width / 2 + random(-4, 4),
